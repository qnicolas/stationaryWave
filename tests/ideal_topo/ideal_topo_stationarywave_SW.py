...
snapshot_id = 'stationarywave_SW_T%i_ideal_topo_nozm'%Ntheta
...
# A bit dirty - should put dimensions in there
ps = 1e3
gamma = 5e-5
...
# Imposed topography
dl = 10 * np.pi / 180
lon0 = 90 * np.pi / 180; lat0 = 30 * np.pi / 180
...
hbottom['g'] = 1 * lon_structure * lat_structure * meter

# # Imposed heating
Q['g'] = 0.

# Mean height field
H0 = (1/Kn) * meter ** 2 / second ** 2 / g 
H['g'] = H0
